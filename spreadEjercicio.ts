...
const combinar = (obj:Object[], obj2:Object) => {
...
let arreglo: string[] = ["amigo", "enemigo", "conocido"];
console.log(...arreglo);

let respuestaArr: string[] | number[] = arreglo.map((e) => {
  return e;
});
...
let algo: string | number = a > b ? "hola" : 3;
console.log(algo);
...
class Fer {
  ...
  set setMensaje( parametro:string) {
    console.log("Llamada desde fuera");
  }
  funcionando(){
    this.funcionando2('algo');
  }
  funcionando2(paramet:string){
...
let color1:object = new String('Verde');
console.log(color1);
